...
read_chunk("./models/exercise-report-2/detailed-model-report.R") 
```
...
```{r print-custom-local-results, echo=F, eval=TRUE, results='asis'}
```
...
```{r print-custom-pooled-results, echo=F, eval=TRUE, results='asis'}
```
