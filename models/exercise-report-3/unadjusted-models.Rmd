...
read_chunk("./models/exercise-report-3/unadjusted-models.R") 
```
...
```{r assemble, echo=echoChunks, results='show', eval=T}
```

```{r declare-variables, echo=echoChunks, results='show', eval=T}
```

```{r model-specification, echo=echoChunks, results='show', eval=T}
```
# Unadjusted models

```{r unadjusted-models, echo=echoChunks, results='asis', eval=T}
```

# Adjusted model
```{r adjusted-model, echo=echoChunks, results='asis', eval=T}
```
