...
read_chunk("./sandbox/visualizing-logistic/visualizing-logistic-easy.R") 
```
...
### Global prob
```{r 1-global-probability, echo=echoChunks, eval=FALSE}
```

### Global odds
```{r 3-global-odds, echo=echoChunks, eval=FALSE}
```

### Local prob
```{r 2-local-probability, echo=echoChunks, eval=FALSE}
```

### Global odds
```{r 4-local-odds, echo=echoChunks, eval=FALSE}
```
