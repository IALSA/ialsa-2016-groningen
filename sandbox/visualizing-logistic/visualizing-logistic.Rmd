...
```{r define-elemental-graph-function, echo=TRUE}
```


```{r define-complex-3-graph-function, echo=TRUE}
```

```{r define-complex-8-graph-function, echo=TRUE}
```

### Study as factor
```{r study-as-factor-in-model, echo=TRUE}
```


### Study as cluster
```{r study-as-individual-data-set, echo=TRUE}
```
