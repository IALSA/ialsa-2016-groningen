...
read_chunk("./sandbox/visualizing-logistic/visualizing-logistic.R") 
```
...
```{r model-plot, echo=echoChunks}
```


### Study as factor
```{r fit-model-with-study-as-factor, echo=TRUE}
```

```{r graph-points-study-as-factor, echo=TRUE}
```

```{r graph-curves-study-as-factor, echo=TRUE}
```



### Study as cluster
```{r fit-model-with-study-as-cluster, echo=TRUE}
```

```{r graph-points-study-as-cluster, echo=TRUE}
```

```{r graph-curves-study-as-cluster, echo=TRUE}
```
