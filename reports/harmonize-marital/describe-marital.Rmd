...
read_chunk("./reports/harmonize-marital/describe-marital.R") 
```
...
## DN0140
```{r share-DN0140, echo=TRUE }
```

# TILDA

## SOCMARRIED
```{r tilda-SOCMARRIED, echo=TRUE }
```

## MAR_4
```{r tilda-MAR_4, echo=TRUE }
```


## CS006
```{r tilda-CS006, echo=TRUE }
```
