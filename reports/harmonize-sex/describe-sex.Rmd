...
read_chunk("./reports/harmonize-sex/describe-sex.R") 
```
...
## GENDER
```{r share-GENDER, echo=TRUE }
```

# TILDA

## SEX
```{r tilda-SEX, echo=TRUE }
```
