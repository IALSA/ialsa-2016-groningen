...
read_chunk("./reports/harmonize-work/describe-work.R") 
```
...
## RETIRED
```{r alsa-RETIRED, echo=TRUE }
```

## CURRWORK
```{r alsa-CURRWORK, echo=TRUE }
```
...
## WE001
```{r tilda-WE001, echo=TRUE }
```

## WE003
```{r tilda-WE003, echo=TRUE }
```
