...
read_chunk("./reports/harmonize-health/describe-health.R") 
```
...
## BTSM12MN
```{r alsa-BTSM12MN, echo=TRUE }
```

## HLTHBTSM
```{r alsa-HLTHBTSM, echo=TRUE }
```

## HLTHLIFE
```{r alsa-HLTHLIFE, echo=TRUE }
```
...
## GGENHLTH
```{r satsa-GGENHLTH, echo=TRUE }
```

## GHLTHOTH
```{r satsa-GHLTHOTH, echo=TRUE }
```
...
## PH0020
```{r share-PH0020, echo=TRUE }
```

## PH0030
```{r share-PH0030, echo=TRUE }
```


## PH0520
```{r share-PH0520, echo=TRUE }
```

## PH0530
```{r share-PH0530, echo=TRUE }
```
...
## PH001
```{r tilda-PH001, echo=TRUE }
```

## PH009
```{r tilda-PH009, echo=TRUE }
```
