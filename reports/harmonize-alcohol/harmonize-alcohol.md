...
1    582 Four or more times a week One or two    Never          TRUE
2   4201           Monthly or less One or two    Never          TRUE
3   4891                     Never       <NA>     <NA>         FALSE
4   7091                     Never       <NA>     <NA>         FALSE
5   7151                     Never       <NA>     <NA>         FALSE
6  18011           Monthly or less One or two    Never          TRUE
7  23882                     Never       <NA>     <NA>         FALSE
8  30531                     Never       <NA>     <NA>         FALSE
9  32811           Monthly or less One or two    Never          TRUE
10 35881           Monthly or less One or two    Never          TRUE
```
...
1  4041062                      <NA>   NA      NA   NA            NA
2  4082053               never drank   NA      NA   NA         FALSE
3  4091083          few times a year   NA      NA   NA          TRUE
4  4102085                      <NA>   NA      NA   NA            NA
5  4151087          few times a year    0       0    0          TRUE
6  4201073     daily or almost daily   12       0    6          TRUE
7  4291071   once or twice per month    2       0    0          TRUE
8  4292020 two or three times weekly    0       6    4          TRUE
9  4381042               never drank   NA      NA   NA         FALSE
10 4432037          few times a year    0       0    0          TRUE
```
...
```
        id GALCOHOL                                 GEVRALK                     GBEERX
1   122601      Yes                                     Yes            1 glass or less
2   144502       No No, I have never drunk alcoholic drinks                       <NA>
3   146312      Yes                                     Yes                       <NA>
4   147191       No                             No, I quit.                       <NA>
5   149502       No                                     Yes                       <NA>
6   158502       No No, I have never drunk alcoholic drinks                       <NA>
7   167501      Yes                                     Yes           1 bottle (33 cl)
8   186912      Yes                                     Yes           1 bottle (33 cl)
9   285602      Yes                                     Yes 3 bottles (two 45 cl cans)
10 2120161      Yes                                     Yes           1 bottle (33 cl)
                                       GLIQX                 GVINX current_drink
1            6 cl (a big shot or equivalent)                 20 cl          TRUE
2                                       <NA>                  <NA>         FALSE
3  4 cl (approx. a small shot or equivalent)                 20 cl          TRUE
4                                       <NA>                  <NA>         FALSE
5  4 cl (approx. a small shot or equivalent)  10 cl (1 wine glass)         FALSE
6                                       <NA>                  <NA>         FALSE
7                                      12 cl                 20 cl          TRUE
8                                       8 cl                 20 cl          TRUE
9                                       8 cl 37 cl (half a bottle)          TRUE
10                                     12 cl                 20 cl          TRUE
```
...
-------------  --------------------------------  --------------------------------  -----------------------  --------------------------------  --------------
 2.505224e+12  less than once a month            not at all in the last 6 months   less than once a month   not at all in the last 6 months   TRUE          
 2.505225e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505239e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505252e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505253e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505258e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505261e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505281e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.505285e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
 2.705295e+12  not at all in the last 6 months   NA                                NA                       NA                                FALSE         
...
1  108821                    yes                   1                 0.00          TRUE
2  138592                    yes                   3                10.50          TRUE
3  169771                    yes                   7                24.50          TRUE
4  311611                     no                   0                 0.00         FALSE
5  355681                   <NA>                  NA                   NA            NA
6  480481                    yes                   4                26.00          TRUE
7  542131                   <NA>                  NA                   NA            NA
8  556891                    yes                   5                 1.75          TRUE
9  569202                   <NA>                  NA                   NA            NA
10 573611                   <NA>                  NA                   NA            NA
```
