...
read_chunk("./reports/harmonization-smoking/harmonization-smoking-basic-graphs.R") 
```
...
## SMOKER
```{r alsa-SMOKER, echo=TRUE }
```

## PIPCIGAR
```{r alsa-PIPCIGAR, echo=TRUE }
```
...
## SMK94
```{r lbsl-SMK94, echo=TRUE }
```

## SMOKE
```{r lbsl-SMOKE, echo=TRUE }
```
...
## GSMOKNOW
```{r satsa-GSMOKNOW, echo=TRUE }
```

## GEVRSMK
```{r satsa-GEVRSMK, echo=TRUE }
```

## GEVRSNS
```{r satsa-GEVRSNS, echo=TRUE }
```
...
## BR0010
```{r share-BR0010, echo=TRUE }
```

## BR0020
```{r share-BR0020, echo=TRUE }
```

## BR0030
```{r share-BR0030, echo=TRUE }
```
...
## BH001
```{r tilda-BH001, echo=TRUE }
```

## BH002
```{r tilda-BH002, echo=TRUE }
```

## BH003
```{r tilda-BH003, echo=TRUE }
```


## BEHSMOKER
```{r tilda-BEHSMOKER, echo=TRUE }
```
