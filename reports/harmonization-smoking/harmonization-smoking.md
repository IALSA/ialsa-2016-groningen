...
Item that can contribute to generating values for the harmonized variable `smoke_now`  are:
...
```
  X SMOKER PIPCIGAR count smoke_now smoked_ever
1 1    Yes      Yes     7       YES          NA
2 2    Yes       No   169       YES          NA
3 3     No      Yes    41       YES          NA
4 4     No     <NA>  1851        NO          NA
5 5   <NA>     <NA>    19      <NA>          NA
```
