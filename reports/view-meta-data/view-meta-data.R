...
# ---- dynamic-table -----------------------------------------------------------
dto[["metaData"]]  %>%
  dplyr::select(name, label, study_name,type,construct, item, categories) %>%
  DT::datatable(class = 'cell-border stripe',
              caption = "Use filtering and sorting to produce custom views to guide your inspection",
               filter = "top", 
              options = list(pageLength = 6, autoWidth = TRUE))

# ---- reproduce ---------------------------------------
rmarkdown::render(input = "./reports/view-meta-data/view-meta-data.Rmd" ,
